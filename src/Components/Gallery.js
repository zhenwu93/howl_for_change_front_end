    ...
    return (
      <section>
        <div className="gallery container grid-ctn">
          ...
          <p className='regtext'>OUR COMMUNITY IS MADE UP OF STORYTELLERS AND CONTENT CREATOR, BOTH VETERAN AND EMERGING, EACH ONE FUELED BY PASSION AND CREATIVITY.</p>

          <div className="grid-container container">

            <div className='grid-row container'>
              <div className="grid-item-div">
                <img src={photo} alt="logo" className="categoryLogo photologo"></img>
              ...
              <div className="grid-item-div">
                <iframe title="video1" className="grid-item video1" src="https://player.vimeo.com/video/345012446" frameBorder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
              </div>

              <div className="grid-item-div">
                <iframe title="video2" className="grid-item video2" align="right" src="https://player.vimeo.com/video/116513060" frameBorder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>

                <img src={video} alt="videologo" className="leftLogo categoryLogo videologo" align="right"></img>
              </div>
            </div>

            <div className='grid-row container'>
              <div className="grid-item-div">
                <img src={music} alt="music" className="categoryLogo musiclogo"></img>
                <iframe title="swan" className="grid-item song1" border="0" src="https://bandcamp.com/EmbeddedPlayer/album=516918889/size=large/bgcol=ffffff/linkcol=0687f5/tracklist=false/transparent=true/"><a href="http://ariansaleh.bandcamp.com/album/swan-bird-googoosh-remixed">Swan Bird (Googoosh Remixed) by Arian Saleh</a></iframe>
              </div>
            ...
            <div className='grid-row container'>
              <div className="grid-item-div">
                <img className="categoryLogo newmedialogo" src={newmedia} alt="newmedia"></img>
                <iframe className="grid-item media1" title="waiting for peace" src="https://www.youtube.com/embed/sRTSJ1K-yn8" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>

              <div className="grid-item-div">
                <iframe className="grid-item media2" title="authentically us" src="https://www.youtube.com/embed/0sNMa9M1_nk" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>

              <div className="grid-item-div">
                <iframe className="grid-item game1" title="origami" src="https://player.vimeo.com/video/338142145" frameBorder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
              </div>

              <div className="grid-item-div">
                <iframe className="grid-item game2" title="1979 revolution" src="https://www.youtube.com/embed/pGeFR8AqM7Q" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                <img className="leftLogo categoryLogo gamelogo" src={gaming} alt="gaming" align="right"></img>
              </div>
            </div>

            <div className='grid-row container'>
              <div className="grid-item-div">
                <img className="categoryLogo programlogo" src={programming} alt="programming"></img>
